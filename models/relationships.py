...
Scene.events = relationship("Event", back_populates="scene", cascade="all, delete-orphan")
Scene.interpretation_sets = relationship("InterpretationSet", back_populates="scene", cascade="all, delete-orphan")
...
InterpretationSet.interpretations = relationship("Interpretation", back_populates="interpretation_set", cascade="all, delete-orphan")

# Interpretation relationships
Interpretation.interpretation_set = relationship("InterpretationSet", back_populates="interpretations")
