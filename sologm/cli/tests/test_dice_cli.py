...
def test_dice_history_command(cli_runner, mock_dice_manager, sample_dice_rolls, mock_session, cli_test_base):
...
def test_dice_roll_error_handling(cli_runner, mock_dice_manager, mock_session, cli_test_base):
