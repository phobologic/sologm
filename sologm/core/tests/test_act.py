...
class TestActManager:
    ...
    def test_list_acts(self, db_session, test_game, test_act, create_test_act, act_manager):
        """Test listing acts."""
        # Create a second act
    ...
    def test_set_active_act(self, db_session, test_game, test_act, create_test_act, act_manager):
    ...
    def test_validate_active_context(self, db_session, test_game, test_act, act_manager):
